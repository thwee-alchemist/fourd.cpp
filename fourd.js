...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5266336,
    DYNAMIC_BASE = 5266336,
    DYNAMICTOP_PTR = 23200;
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_fourd_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=23248;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
...
function nullFunc_iiffffff(x) { err("Invalid function pointer called with signature 'iiffffff'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
var asmLibraryArg = {
  ...
  "nullFunc_iiffffff": nullFunc_iiffffff,
...
var real___GLOBAL__sub_I_fourd_cpp = asm["__GLOBAL__sub_I_fourd_cpp"]; asm["__GLOBAL__sub_I_fourd_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_fourd_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_fourd_cpp = Module["__GLOBAL__sub_I_fourd_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_fourd_cpp"].apply(null, arguments) };
...
var dynCall_iiffffff = Module["dynCall_iiffffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iiffffff"].apply(null, arguments) };
